...
ID_TOKEN_MASK = 151666 # '<|mask|>'
ID_TOKEN_PADDING = 151643 # '<|endoftext|>'
ID_TOKEN_EOT = 151643 # '<|endoftext|>'
ID_TOKEN_BOT = 151665 # '<|beginoftext|>'
...
'''define llada supportive functions'''
            ...
            for num_blocks_g in (8,4,1):
                for num_unmask_per_iter_g in (1,2,4):
                    ...
                    for batch in tqdm(loader):
                        ...
                        with open(f'{folder_log_base}/{len_prompt_g}-{len_target_g}-{num_blocks_g}-{num_unmask_per_iter_g}.dream', 'a+') as file:
