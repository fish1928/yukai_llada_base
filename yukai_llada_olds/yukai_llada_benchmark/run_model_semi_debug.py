    ...
    def generate(self, model, tokenizer, config_diffusion, *args, **kwargs):
        ...
        for id_block in range(num_blocks):
            ...
            for step in range(step_per_block):
                ...
                token_updated = tokenizer.batch_decode(x.gather(1, idx_transform))[0]
                jprint('[{}|{}|{}]: {}\n'.format(step, idx_transform.squeeze(0).item(), token_updated, tokenizer.batch_decode(x[:, position_end-size_block:position_end])[0]))
            # end for step
